...
export const fontsStyle = () => {
   ...
   // Если передан флаг --frw удаляем файл подключения шрифтов
   app.isFRW ? fs.unlink(fontsFile, cb) : null;
         ...
         if (!fs.existsSync(fontsFile)) {
            ...
            for (var i = 0; i < fontsFiles.length; i++) {
               ...
               if (newFileOnly !== fontFileName) {
                  ...
                  if (fontWeight.toLowerCase().includes("thin") || fontWeight.toLowerCase().includes("hairline")) {
                     fontWeight = 100;
                  } else if (fontWeight.toLowerCase().includes("extralight") || fontWeight.toLowerCase().includes("ultralight")) {
                     fontWeight = 200;
                  } else if (fontWeight.toLowerCase().includes("light")) {
                     fontWeight = 300;
                  } else if (fontWeight.toLowerCase().includes("medium")) {
                     fontWeight = 500;
                  } else if (fontWeight.toLowerCase().includes("semibold") || fontWeight.toLowerCase().includes("demibold")) {
                     fontWeight = 600;
                  } else if (fontWeight.toLowerCase().includes("bold")) {
                     fontWeight = 700;
                  } else if (fontWeight.toLowerCase().includes("extrabold") || fontWeight.toLowerCase().includes("ultrabold")) {
                     fontWeight = 800;
                  } else if (fontWeight.toLowerCase().includes("black") || fontWeight.toLowerCase().includes("heavy")) {
                     fontWeight = 900;
                  } else {
                     fontWeight = 400;
                  }
